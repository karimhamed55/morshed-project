        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PlaceFromId = table.Column<int>(type: "int", nullable: false),
                    PlaceToId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TransportOptions_Places_PlaceFromId",
                        column: x => x.PlaceFromId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransportOptions_Places_PlaceToId",
                        column: x => x.PlaceToId,
                        principalTable: "Places",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransportOptions_PlaceFromId",
                table: "TransportOptions",
                column: "PlaceFromId");

            migrationBuilder.CreateIndex(
                name: "IX_TransportOptions_PlaceToId",
                table: "TransportOptions",
                column: "PlaceToId");
        }
